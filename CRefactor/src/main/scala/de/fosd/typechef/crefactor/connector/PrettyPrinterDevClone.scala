...
import scala.{Some, Int}
import de.fosd.typechef.conditional._

object PrettyPrinterDevClone {
  ...
  def prettyPrint(ast: AST, list_feature_expr: List[FeatureExpr] = List(FeatureExprFactory.True)): Doc = {
    ...
    ast match {
      ...
      case Id(name) => name + " (Name) \n "
      case Constant(v) => v + " (Konstante) \n "
      ...
      case VoidSpecifier() => "void" + "VoidSpecifier \n "
      case ShortSpecifier() => "short" + "ShortSpecifier \n "
      case IntSpecifier() => "int" + " (IntSpecifier) \n "
      case FloatSpecifier() => "float" + "FloatSpecifier \n "
      case LongSpecifier() => "long" + "LongSpecifier \n "
      case CharSpecifier() => "char" + "CharSpecifier \n "
      case DoubleSpecifier() => "double" + "DoubleSpecifier \n "
