...
// #/string_id_map#
    ...
    final public  String getSourceString() { return sourceString; }

    final  public int getLineno() { return lineno; }

    final public String getString() { return string; }

    final public  char getQuoteChar() {
        return (char) quoteChar;
    }

    final  public double getNumber() { return number; }
    final public  boolean isNumberOctal() { return isOctal; }

    final  public boolean eof() { return hitEOF; }

    final public int getToken() throws IOException
    {
        int c;
...
//                                        < Context.VERSION_1_7)
//                        {
//XXX                            // LET and YIELD are tokens only in 1.7 and later
...
//                        }
                        ...
                        if (result != Token.RESERVED) {
                            return result;
//XXX                        } else if (!parser.compilerEnv.
