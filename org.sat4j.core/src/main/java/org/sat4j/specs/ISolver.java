...
public interface ISolver extends IProblem, Serializable {
     ...
     * vocabulary).
     *
     * @param howmany number of variables to create
     ...
     *
     * @param reserve if true, the maxVarId is updated in the solver, i.e.
     ...
     * newVar(int)
     *
     * @param nb the expected number of clauses.
     * @see #newVar(int)
     * @since 1.6
     */
     ...
     *         removeConstr().
     * @throws ContradictionException iff the vector of literals is empty or if it contains only
     ...
     *
     * @param c a constraint returned by one of the add method.
     ...
     *
     * @param c a constraint returned by one of the add method. It must be the
     ...
     *
     * @param clauses a vector of set (VecInt) of literals in the dimacs format. The
     ...
     * must be satisfied"
     *
     * @param literals a set of literals The vector can be reused since the solver is
     *                 not supposed to keep a reference to that vector.
     * @param degree   the degree of the cardinality constraint
     * @return a reference to the constraint added in the solver, to use in
     *         removeConstr().
     * @throws ContradictionException iff the vector of literals is empty or if it contains more
     ...
     * must be satisfied"
     *
     * @param literals a set of literals. The vector can be reused since the solver
     *                 is not supposed to keep a reference to that vector.
     * @param degree   the degree of the cardinality constraint
     * @return a reference to the constraint added in the solver, to use in
     *         removeConstr().
     * @throws ContradictionException iff the vector of literals is empty or if degree literals are
     ...
     *
     * @param count the timeout (in number of counflicts)
     */
     ...
     *
     * @param value true to allow the solver to output messages on the console,
     *              false either.
     * @since 2.2
     */
     ...
     *
     * @param prefix the prefix to be in front of each line of text
     * @since 2.2
     */
