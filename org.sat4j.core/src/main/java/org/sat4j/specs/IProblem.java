...
public interface IProblem {
     ...
     *
     * @param var the variable id in Dimacs format
     ...
     * solver.
     *
     * @param assumps       a set of literals (represented by usual non null integers
     *                      in Dimacs format).
     * @param globalTimeout whether that call is part of a global process (i.e.
     ...
     * @throws TimeoutException if a model cannot be found within the given timeout.
     * @since 1.7
     */
     ...
     *
     * @param out    the place to print the information
