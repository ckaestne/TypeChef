...
public class MinWatchCard implements Constr, Undoable, Serializable {
     ...
     *
     * @param voc      vocabulary used by the constraint
     * @param ps       literals involved in the constraint
     * @param moreThan should be ATLEAST or ATMOST;
     * @param degree   degree of the constraint
     */
     ...
     *
     * @param p         falsified literal (or Lit.UNDEFINED)
     * @param outReason the reason to be computed. Vector of literals.
     ...
     *
     * @param claInc value to be added to the activity of the constraint
     ...
     * minimale
     *
     * @param s        tool for propagation
     * @param voc      vocalulary used by the constraint
     * @param ps       literals involved in the constraint
     * @param moreThan sign of the constraint. Should be ATLEAST or ATMOST.
     * @param degree   degree of the constraint
     ...
     *
     * @param s tool for literal propagation
     * @param p falsified literal
