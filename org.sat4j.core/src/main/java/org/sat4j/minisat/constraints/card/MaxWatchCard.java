...
public final class MaxWatchCard implements Constr, Undoable, Serializable {
     ...
     *
     * @param size   nombre de litt?raux de la contrainte
     * @param learnt indique si la contrainte est apprise
     */
     ...
     *
     * @param p         un litt?ral falsifi? (ou Lit.UNDEFINED)
     * @param outReason vecteur de litt?raux ? remplir
     ...
     *
     * @param claInc incr?ment de l'activit? de la contrainte
     ...
     *
     * @param s        outil pour la propagation des litt?raux
     * @param voc      vocabulaire utilis? par la contrainte
     * @param ps       liste des litt?raux de la nouvelle contrainte
     * @param moreThan d?termine si c'est une sup?rieure ou ?gal ? l'origine
     * @param degree   fournit le degr? de la contrainte
     ...
     *
     * @param s objet utilis? pour la propagation
     * @param p le litt?ral propag? (il doit etre falsifie)
