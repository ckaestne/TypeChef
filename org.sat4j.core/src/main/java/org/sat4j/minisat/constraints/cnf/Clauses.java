...
public abstract class Clauses {
     ...
     *
     * @param ps  the list of literals
     * @param voc the vocabulary used
     * @param s   the object responsible for unit propagation
     * @return null if the clause should be ignored, the (possibly modified)
     *         list of literals otherwise
     * @throws ContradictionException if discovered by unit propagation
     */
     ...
     *
     * @param p the list of literals (supposed to be clean as after a call to
     *          sanityCheck())
     * @param s the object responsible for unit propagation
     * @return true iff the clause should be ignored (because it's unit)
     * @throws ContradictionException when detected by unit propagation
     */
