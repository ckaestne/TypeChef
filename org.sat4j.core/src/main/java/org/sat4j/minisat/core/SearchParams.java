...
public class SearchParams implements Serializable {
    ...
    /**
     * @param d variable decay
     * @param e clause decay
     * @param f conflict bound increase factor
     * @param i initialConflictBound
     */
    ...
    /**
     * @param conflictBoundIncFactor the conflictBoundIncFactor to set
     */
    ...
    /**
     * @param initConflictBound the initConflictBound to set
     */
    ...
    /**
     * @param claDecay the claDecay to set
     */
    ...
    /**
     * @param varDecay the varDecay to set
     */
