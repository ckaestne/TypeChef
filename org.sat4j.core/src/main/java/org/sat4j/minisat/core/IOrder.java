...
public interface IOrder {
     ...
     *
     * @param out    the writer to display the information in
     * @param prefix to be used in front of each newline.
     */
     ...
     * variable activity.
     *
     * @param d a number bigger than 1 that will increase the activity of the
