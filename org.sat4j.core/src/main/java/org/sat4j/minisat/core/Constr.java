...
public interface Constr extends Propagatable, IConstr {
     ...
     * or a falsified one.
     *
     * @param p         a satisfied literal (or Lit.UNDEFINED)
     * @param outReason the list of falsified literals whose negation is the reason of
     ...
     *
     * @param s a UnitPropagationListener to use for unit propagation.
     */
