...
public abstract class AbstractLauncher implements Serializable {
     ...
     *
     * @param problemname the fully qualified name of the problem.
     * @return a reference to the problem to solve
     * @throws FileNotFoundException  if the file is not found
     * @throws ParseFormatException   if the problem is not expressed using the right format
     ...
     *
     * @param exitCode the new ExitCode
     */
