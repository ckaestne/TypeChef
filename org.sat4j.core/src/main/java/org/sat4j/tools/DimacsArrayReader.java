...
public class DimacsArrayReader implements Serializable {
    ...
    /**
     * @param gateType gateType[i] is the type of gate i according to the Extended
     *                 Dimacs specs; ignored in DimacsArrayReader, but important for
     *                 inheriting classes
     * @param outputs  outputs[i] is the number of the output; ignored in
     *                 DimacsArrayReader
     * @param inputs   inputs[i] contains the clauses in DimacsArrayReader; an
     *                 overriding class might have it contain the inputs of the
     *                 current gate
     * @param maxVar   the maximum number of assigned ids
     * @throws ContradictionException si le probleme est trivialement inconsitant
     */
