...
public class ExtendedDimacsArrayReader extends DimacsArrayReader {
     ...
     *
     * @param gateType the type of the gate in question
     * @param output   the number of the output of the gate in question
     * @param inputs   the numbers of the inputs of the gates in question; the array
