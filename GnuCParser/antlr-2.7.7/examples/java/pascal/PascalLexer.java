...
tryAgain:
	...
	public final void mLBRACK2(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = LBRACK2;
		int _saveIndex;
	...
	public final void mRBRACK2(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = RBRACK2;
		int _saveIndex;
