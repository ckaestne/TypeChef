...
public interface GNUCTokenTypes {
	...
	int Exponent = 139;
	int Number = 140;
	int LITERAL_restrict = 141;
	int LITERAL___label__ = 142;
	int LITERAL_inline = 143;
	int LITERAL__Bool = 144;
	int LITERAL__Complex = 145;
	int LITERAL_typeof = 146;
	int LITERAL___complex = 147;
	int LITERAL___attribute__ = 148;
	int LITERAL___alignof = 149;
	int LITERAL___real = 150;
	int LITERAL___imag = 151;
	int LITERAL___builtin_offsetof = 152;
}
