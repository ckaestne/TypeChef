...
strOptExprPair
        :  (LBRACKET ID RBRACKET)? stringConst ( LPAREN expr RPAREN )?
        ;
...
offsetofMemberDesignator: 
		  ID (DOT ID)* ;//offsetofMemberDesignatorEnd?;

//offsetofMemberDesignatorEnd: LBRACKET expr RBRACKET;
