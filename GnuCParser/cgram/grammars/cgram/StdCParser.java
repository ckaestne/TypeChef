...
inputState.guessing--;
		...
		try {      // for error handling
			...
			do {
				if ((LA(1)==STAR)) {
					...
					else if ((_tokenSet_34.member(LA(1))) && (_tokenSet_33.member(LA(2)))) {
					}
					else {
						throw new NoViableAltException(LT(1), getFilename());
					}
	...
	public final void parameterDeclaration() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			if (((_tokenSet_10.member(LA(1))) && (_tokenSet_32.member(LA(2))))) {
				int _m92 = mark();
	...
	public final void statement() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			case LITERAL_if:
			{
				...
				astFactory.addASTChild(currentAST, returnAST);
				{
				if ((LA(1)==LITERAL_else) && (_tokenSet_44.member(LA(2)))) {
				...
				else if ((_tokenSet_45.member(LA(1))) && (_tokenSet_42.member(LA(2)))) {
				}
				else {
					throw new NoViableAltException(LT(1), getFilename());
				}
			...
			default:
				if ((_tokenSet_11.member(LA(1))) && (_tokenSet_46.member(LA(2)))) {
					expr();
					astFactory.addASTChild(currentAST, returnAST);
					match(SEMI);
					if ( inputState.guessing==0 ) {
					...
					match(COLON);
					{
					if ((_tokenSet_44.member(LA(1))) && (_tokenSet_47.member(LA(2)))) {
						statement();
						astFactory.addASTChild(currentAST, returnAST);
					}
					else if ((_tokenSet_45.member(LA(1))) && (_tokenSet_42.member(LA(2)))) {
...
inputState.guessing--;
			...
			else if ((_tokenSet_11.member(LA(1))) && (_tokenSet_60.member(LA(2)))) {
				unaryExpr();
				astFactory.addASTChild(currentAST, returnAST);
				castExpr_AST = (TNode)currentAST.root;
			}
...
inputState.guessing--;
	...
	private static final long[] mk_tokenSet_33() {
		long[] data = { -562812514467888L, 17179082751L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_33 = new BitSet(mk_tokenSet_33());
	private static final long[] mk_tokenSet_34() {
		long[] data = { 32614907904L, 0L, 0L};
		return data;
	}
