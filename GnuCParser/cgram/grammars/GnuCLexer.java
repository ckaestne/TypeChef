...
public class GnuCLexer extends antlr.CharScanner implements GnuCLexerTokenTypes, TokenStream
 {
  ...
  public void initialize() 
  {
    ...
    literals.put(new ANTLRHashString("__attribute__", this), new Integer(LITERAL___attribute__));
...
public GnuCLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("inline", this), new Integer(143));
	...
	literals.put(new ANTLRHashString("__label__", this), new Integer(142));
	...
	literals.put(new ANTLRHashString("_Complex", this), new Integer(145));
	...
	literals.put(new ANTLRHashString("__builtin_offsetof", this), new Integer(152));
	...
	literals.put(new ANTLRHashString("_Bool", this), new Integer(144));
	literals.put(new ANTLRHashString("continue", this), new Integer(41));
	literals.put(new ANTLRHashString("__attribute__", this), new Integer(148));
	literals.put(new ANTLRHashString("struct", this), new Integer(10));
	literals.put(new ANTLRHashString("restrict", this), new Integer(141));
