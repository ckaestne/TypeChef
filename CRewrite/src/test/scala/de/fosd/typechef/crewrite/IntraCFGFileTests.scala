...
class IntraCFGFileTests extends TestHelper with EnforceTreeHelper with IntraCFG with ConditionalNavigation with CFGHelper {
  ...
  @Ignore def test_20000211_1() {assert(checkCFG("20000211-1.c") == false)}
  ...
  // test fails
  @Ignore def test_20000701_1() {assert(checkCFG("20000701-1.c") == false)}
  ...
  @Ignore def test_20000802_1() {assert(checkCFG("20000802-1.c") == false)}
  ...
  @Ignore def test_20001018_1() {assert(checkCFG("20001018-1.c") == false)}
  ...
  @Ignore def test_20001221_1() {assert(checkCFG("20001221-1.c") == false)}
  ...
  @Ignore def test_20010518_1() {assert(checkCFG("20010518-1.c") == false)}
  ...
  // test fails
  @Ignore def test_20011109_1() {assert(checkCFG("20011109-1.c") == false)}
  ...
  @Ignore def test_20011130_1() {assert(checkCFG("20011130-1.c") == false)}
  @Ignore def test_20011130_2() {assert(checkCFG("20011130-2.c") == false)}
  ...
  @Ignore def test_20011219_1() {assert(checkCFG("20011219-1.c") == false)}
  @Ignore def test_20011219_2() {assert(checkCFG("20011219-2.c") == false)}
  @Ignore def test_20011229_1() {assert(checkCFG("20011229-1.c") == false)}
  ...
  @Ignore def test_20020206_1() {assert(checkCFG("20020206-1.c") == false)}
  ...
  @Ignore def test_20020604_1() {assert(checkCFG("20020604-1.c") == false)}
  ...
  @Ignore def test_20030224_1() {assert(checkCFG("20030224-1.c") == false)}
  ...
  @Ignore def test_20030904_1() {assert(checkCFG("20030904-1.c") == false)}
  ...
  @Ignore def test_20031220_1() {assert(checkCFG("20031220-1.c") == false)}
  ...
  @Ignore def test_20040304_1() {assert(checkCFG("20040304-1.c") == false)}
  ...
  @Ignore def test_920409_1() {assert(checkCFG("920409-1.c") == false)}
  @Ignore def test_920409_2() {assert(checkCFG("920409-2.c") == false)}
  @Test def test_920410_1() {assert(checkCFG("920410-1.c") == false)}
  @Test def test_920410_2() {assert(checkCFG("920410-2.c") == false)}
  @Ignore def test_920411_2() {assert(checkCFG("920411-2.c") == false)}
  ...
  @Ignore def test_920428_2() {assert(checkCFG("920428-2.c") == false)}
  ...
  @Ignore def test_920625_2() {assert(checkCFG("920625-2.c") == false)}
  ...
  // test fails;
  @Ignore def test_920928_2() {assert(checkCFG("920928-2.c") == false)}
  ...
  @Ignore def test_921011_2() {assert(checkCFG("921011-2.c") == false)}
  @Test def test_921012_1() {assert(checkCFG("921012-1.c") == false)}
  @Test def test_921012_2() {assert(checkCFG("921012-2.c") == false)}
  @Ignore def test_921013_1() {assert(checkCFG("921013-1.c") == false)}
  ...
  @Ignore def test_921206_1() {assert(checkCFG("921206-1.c") == false)}
  ...
  @Ignore def test_930427_2() {assert(checkCFG("930427-2.c") == false)}
  ...
  @Ignore def test_950816_2() {assert(checkCFG("950816-2.c") == false)}
  ...
  @Ignore def test_981007_1() {assert(checkCFG("981007-1.c") == false)}
  @Ignore def test_981022_1() {assert(checkCFG("981022-1.c") == false)}
  ...
  @Ignore def test_990117_1() {assert(checkCFG("990117-1.c") == false)}
  @Test def test_990203_1() {assert(checkCFG("990203-1.c") == false)}
  @Ignore def test_990517_1() {assert(checkCFG("990517-1.c") == false)}
  ...
  @Ignore def test_991213_2() {assert(checkCFG("991213-2.c") == false)}
