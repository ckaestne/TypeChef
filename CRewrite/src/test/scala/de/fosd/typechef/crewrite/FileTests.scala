...
class FileTests extends TestHelper with EnforceTreeHelper with CASTEnv with ConditionalControlFlow {
  ...
  @Test def test_20010408_1() {assert(checkCfg("20010408-1.c"))}
  ...
  @Test def test_20011114_3() {assert(checkCfg("20011114-3.c"))}
  ...
  @Test def test_20020314_1() {assert(checkCfg("20020314-1.c"))}
  ...
  @Test def test_goto_1() {assert(checkCfg("goto-1.c"))}
