...
class FileTests extends TestHelper with EnforceTreeHelper with CASTEnv with ConditionalControlFlow {
  ...
  // test fails
  @Ignore def test_20000326_1() {assert(checkCfg("20000326-1.c"))}
  ...
  // test fails
  @Ignore def test_20010320_1() {assert(checkCfg("20010320-1.c"))}
  ...
  // test fails
  @Ignore def test_20011109_1() {assert(checkCfg("20011109-1.c"))}
  ...
  // test fails
  @Ignore def test_20011114_4() {assert(checkCfg("20011114-4.c"))}
  ...
  // test fails
  @Ignore def test_20011229_2() {assert(checkCfg("20011229-2.c"))}
  ...
  // test fails
  @Ignore def test_20020116_1() {assert(checkCfg("20020116-1.c"))}

  // test fails
  @Ignore def test_20020120_1() {assert(checkCfg("20020120-1.c"))}
  ...
  // test fails
  @Ignore def test_20020604_1() {assert(checkCfg("20020604-1.c"))}

  // test fails
  @Ignore def test_20020605_1() {assert(checkCfg("20020605-1.c"))}
  ...
  // test fails
  @Ignore def test_20030110_1() {assert(checkCfg("20030110-1.c"))}
  ...
  // test fails
  @Ignore def test_20031011_2() {assert(checkCfg("20031011-2.c"))}
  ...
  // test fails
  @Ignore def test_20031031_2() {assert(checkCfg("20031031-2.c"))}
  ...
  // test fails
  @Ignore def test_20031220_2() {assert(checkCfg("20031220-2.c"))}
  ...
  // test fails
  @Ignore def test_20041007_1() {assert(checkCfg("20041007-1.c"))}
  ...
  // test fails
  @Ignore def test_920501_18() {assert(checkCfg("920501-18.c"))}
  ...
  // test fails
  @Ignore def test_920501_23() {assert(checkCfg("920501-23.c"))}
  ...
  // test fails
  @Ignore def test_920817_1() {assert(checkCfg("920817-1.c"))}
  ...
  // test fails
  @Ignore def test_920928_3() {assert(checkCfg("920928-3.c"))}
  ...
  // test fails
  @Ignore def test_921202_2() {assert(checkCfg("921202-2.c"))}
  ...
  // test fails
  @Ignore def test_930120_1() {assert(checkCfg("930120-1.c"))}
  @Test def test_930126_1() {assert(checkCfg("930126-1.c"))}

  // test fails
  @Ignore def test_930210_1() {assert(checkCfg("930210-1.c"))}
  ...
  // test fails
  @Ignore def test_930527_1() {assert(checkCfg("930527-1.c"))}
  ...
  // test fails
  @Ignore def test_980825_1() {assert(checkCfg("980825-1.c"))}
  ...
  // test fails
  @Ignore def test_981006_1() {assert(checkCfg("981006-1.c"))}
  ...
  // test fails
  @Ignore def test_990617_1() {assert(checkCfg("990617-1.c"))}
  ...
  // test fails
  @Ignore def test_990801_2() {assert(checkCfg("990801-2.c"))}
  ...
  // test fails
  @Ignore def test_991229_1() {assert(checkCfg("991229-1.c"))}
