...
class FileTests extends TestHelper with EnforceTreeHelper with CASTEnv with ConditionalControlFlow {
    ...
    // test fails; False code in succ determination
    @Ignore def test_20000105_1() {
        assert(checkCfg("20000105-1.c"))
    }
    @Test def test_20000105_2() {
        assert(checkCfg("20000105-2.c"))
    }
    @Test def test_20000120_1() {
    ...
    @Ignore def test_20000728_1() {
        assert(checkCfg("20000728-1.c"))
    }
    @Test def test_20000802_1() {
    ...
    @Test def test_20011130_1() {
        assert(checkCfg("20011130-1.c"))
    }
    @Test def test_20011130_2() {
    ...
    @Test def test_20011219_1() {
        assert(checkCfg("20011219-1.c"))
    }
    @Test def test_20011219_2() {
        assert(checkCfg("20011219-2.c"))
    }
    @Test def test_20011229_1() {
    ...
    // test fails; False code break after return
    ...
    @Test def test_920409_1() {
        assert(checkCfg("920409-1.c"))
    }
    @Test def test_920409_2() {
    ...
    @Test def test_921011_1() {
        assert(checkCfg("921011-1.c"))
    }
    @Test def test_921011_2() {
    ...
    @Test def test_981007_1() {
        assert(checkCfg("981007-1.c"))
    }
    @Test def test_981022_1() {
    ...
    @Test def test_labels_1() {
        assert(!checkCfg("labels-1.c"))
    }
    @Test def test_labels_2() {
    ...
    @Ignore def test_bug07() {
        assert(checkCfg("bug07.c"))
    }
    @Ignore def test_bug08() {
        assert(checkCfg("bug08.c"))
    }
    @Ignore def test_bug09() {
        assert(checkCfg("bug09.c"))
    }
    @Ignore def test_bug10() {
        assert(checkCfg("bug10.c"))
    }
    @Ignore def test_bug11() {
        assert(checkCfg("bug11.c"))
    }
    @Ignore def test_bug12() {
    ...
    // test fails; infinite loop
    @Ignore def test_gzip() {
        assert(checkCfg("gzip.c"))
    }
}
