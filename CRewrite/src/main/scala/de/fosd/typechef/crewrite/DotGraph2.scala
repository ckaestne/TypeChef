...
class DotGraph2(fwriter: Writer) extends IOUtilities with CFGWriter {
    ...
    private val featureNodeFontName = "Calibri"
    private val featureNodeFontColor = "black"
    ...
    private val featureConnectionEdgeThickness = "setlinewidth(4)"
