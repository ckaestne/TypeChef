...
class SparseFileTest extends TestHelper {
    ...
    @Test def test_label_asm {checkSparse("label-asm.c")}
    @Test def test_label_attr {checkSparse("label-attr.c")}
    @Test def test_label_scope {checkSparse("label-scope.c")}
    @Test def test_local_label {checkSparse("local-label.c")}
    @Test def test_logical {checkSparse("logical.c")}
    @Test def test_member_of_typeof {checkSparse("member_of_typeof.c")}
    ...
    @Test def test_static_forward_decl {checkSparse("static-forward-decl.c")}
    ...
    @Test def test_typedef_shadow {checkSparse("typedef_shadow.c")}
    @Test def test_typeof_attribute {checkSparse("typeof-attribute.c")}
    @Test def test_typesign {checkSparse("typesign.c")}
    @Test def test_varargs1 {checkSparse("varargs1.c")}
