...
//
//class ErrorMsg(msg: String, callers: List[AST], target: List[AST]) {
//    override def toString = msg + " (" + callers.mkString(", ") + ") => " + target.mkString(" || ")
//}
//
//case class ErrorMsgs(name: String, callers: List[(FeatureExpr, AST)], targets: List[AST]) {
...
//}
//
//case class RedefErrorMsg(name: String, newDef: AST, priorFExpr: FeatureExpr) {
